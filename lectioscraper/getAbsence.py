...
def get_absence(to_json, SchoolId, studentId, Session, written_assignments):
    ...
    absence_rows = soup.find("table", {"id": "s_m_Content_Content_SFTabStudentAbsenceDataTable"}).findAll("tr")
    ...
    for i in absence_rows:
        ...
        if written_assignments is False:
            if len(absence) == 9:
                absence_end_result[absence[0]] = {"team": absence[0], "opgjort": {"procent": absence[1], "moduler": absence[2]}, "for_the_year": {"procent": absence[3], "moduler": absence[4]}}
        else:
            if len(absence) == 9:
                absence_end_result[absence[0]] = {"team": absence[0], "opgjort": {"procent": absence[1], "moduler": absence[2]}, "for_the_year": {"procent": absence[3], "moduler": absence[4]}, "writing": {"opgjort": {"procent": absence[5], "elevtid": absence[6]}, "for_the_year_wrting": {"procent": absence[7], "elevtid": absence[8]}}}
