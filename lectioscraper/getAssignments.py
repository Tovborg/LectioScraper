...
def get_assignments(to_json, team, status, fravaer, karakter, Session, SchoolId, studentId):
    ASSIGNMENT_URL = "https://www.lectio.dk/lectio/{}/OpgaverElev.aspx?elevid={}".format(SchoolId, studentId)
