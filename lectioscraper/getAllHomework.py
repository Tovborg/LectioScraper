...
def get_all_homework(to_json, print_to_console, SchoolId, studentId, Session):
    HOMEWORK_URL = "https://www.lectio.dk/lectio/{}/material_lektieoversigt.aspx?elevid={}".format(SchoolId, studentId)
    ...
    for lektie in lektierows:
        ...
        aktivitetcontainer = lektie.find_all("td", {"class": "textTop"})[0].find("a", {"class": "s2bgbox"})
